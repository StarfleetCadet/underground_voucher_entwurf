...
class VoucherTemplateDao {
    ...
    const COL_BARCODE_POS = "barcode_pos";
    const COL_PAPER_SIZE = "paper_size";
    ...
    public function insert_template($template) {
        ...
        $wpdb->insert($this->table_name,
            array(
                ...
                self::COL_BARCODE_POS => $template->getBarcodePos(),
                self::COL_PAPER_SIZE => $template->getPaperSize(),
    ...
    public function get_template_by_id($id) {
        ...
        $query = "SELECT * FROM $this->table_name WHERE code='$id'";
    ...
    public function get_all_templates() {
        ...
        $query = "SELECT * FROM $this->table_name WHERE deleted = FALSE ";
    ...
    private function templateFromResult($res) {
        ...
        $template->setBarcodePos($res[self::COL_BARCODE_POS]);
        $template->setPaperSize($res[self::COL_PAPER_SIZE]);
